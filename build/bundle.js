...
/***/ function(module, exports, __webpack_require__) {
	...
	var reactApp = _react2.default.createElement(
	...
	(0, _reactDom.render)(reactApp, reactRoot);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } } /* Todos reducer, manages state related w/ todos */
